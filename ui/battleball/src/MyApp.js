...
var MapLayer = cc.Layer.extend({
    ...
    initmaplayer: function(msg){
        ...
        for(var x = 0; x < this.mapwidth; x++){
			var l = cc.LabelTTF.create("" + x, "Tahoma", 18);
			l.setPosition(x * blockwidth + blockwidth / 2, this.mapheight * blockheight + blockheight / 2);
			this.addChild(l);
        }
        for(var y = 0; y < this.mapwidth; y++){
			var l = cc.LabelTTF.create("" + y, "Tahoma", 18);
			l.setPosition(-blockwidth + blockwidth / 2, (this.mapheight - y - 1) * blockheight + blockheight / 2);
			this.addChild(l);
        }
...
var GameLayer = cc.Layer.extend({
    ...
    gamestart: function (msg) {
        ...
        var leftedgewidth = size.width * 255 / 1280;
        this.ignoreAnchorPointForPosition(false);
